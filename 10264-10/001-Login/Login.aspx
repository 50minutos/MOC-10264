<%@ Page Title="" Language="C#" MasterPageFile="~/Modelo.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="_001_Login.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <asp:HyperLink NavigateUrl="~/EsqueciMinhaSenha.aspx" runat="server" Text="Esqueci a minha senha"/>
</asp:Content>
